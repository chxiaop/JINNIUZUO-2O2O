...
//	
//	
//		imu_gimbal.wx = rm_imu_data.gyro_int16[0];
//		imu_gimbal.wy = rm_imu_data.gyro_int16[1];
//		imu_gimbal.wz = rm_imu_data.gyro_int16[2];
//		
...
// {
//	 if( imu_gimbal.pitch == imu_gimbal.pitch_last && imu_gimbal.roll == imu_gimbal.roll_last && imu_gimbal.yaw == imu_gimbal.yaw_last)
//	 {
//	  imu_gimbal.status = 0;
//	 }
//	 else
...
//	 imu_gimbal.status = 1;
//	 }
//  imu_gimbal.pitch_last = imu_gimbal.pitch;
//  imu_gimbal.roll_last = imu_gimbal.roll;
//	imu_gimbal.yaw_last = imu_gimbal.yaw;
// }
